...
<%
    List<Product> productBeImport   = (List<Product>) request.getAttribute("productBeImport");
    if (productBeImport == null) productBeImport  = new ArrayList<>();
%>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="table-id" class="table table-hover table-bordered">
                        ...
                        <tbody>
                        <%
                            for (Product product : productBeImport) {
