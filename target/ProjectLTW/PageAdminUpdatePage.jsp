...
<section class="home-section">
  <div class="home-content">
    <div class="manager-product">
      ...
      <form id="myForm" action="PageAdminUpdatePage?id=<%=post.getId()%>" method="post" class="row">
        <input type="hidden" name="postId" value="" />
<%--        <div class="form-group col-md-3">--%>
<%--          <label class="control-label">Mã</label>--%>
<%--          <input name="id" class="form-control" type="text" value="<%= post.getId() %>">--%>
<%--        </div>--%>
        <div class="form-group col-md-3">
          <label class="control-label">Id</label>
          <input name="id" class="form-control" type="text" value="<%= post.getId() %>" disabled>        </div>
        <div class="form-group col-md-3">
