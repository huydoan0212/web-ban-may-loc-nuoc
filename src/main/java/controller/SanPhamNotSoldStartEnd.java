...
@WebServlet(name = "SanPhamNotSoldStartEnd", value = "/sanPhamNotSoldStartEnd")
public class SanPhamNotSoldStartEnd extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Product> productsNotSolds = PageAdminService.getInstance().getProductsNotSoldStartEnd(startDate,endDate);
        System.out.println(productsNotSolds);
