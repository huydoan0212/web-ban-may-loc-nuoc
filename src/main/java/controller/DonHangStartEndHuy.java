...
@WebServlet(name = "DonHangStartEndHuy", value = "/donHangStartEndHuy")
public class DonHangStartEndHuy extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Order> listOrdersCancel = PageAdminService.getInstance().getOrderRecentCanceledStartEnd(startDate, endDate);
        request.setAttribute("listOrdersCancel", listOrdersCancel);
        System.out.println(listOrdersCancel);
