...
public class UserDAO {
  ...
  public static String getEmail(String username) {
    String email = String.valueOf(JDBIConnector.me().withHandle((HandleCallback<Optional<String>, RuntimeException>) handle ->
  ...
  public static boolean updateUserAddressById(String address, int id) {
    ...
    public static boolean addUser(String username, String fullname, String email, String phoneNumber, String password) {
      int rowsInserted = JDBIConnector.me().withHandle(handle ->
        handle.createUpdate("INSERT INTO users (username, fullname, email, phone_number, password) " +
            "VALUES (:username, :fullname, :email, :phoneNumber, :password)")
          .bind("username", username)
          .bind("fullname", fullname)
          .bind("email", email)
