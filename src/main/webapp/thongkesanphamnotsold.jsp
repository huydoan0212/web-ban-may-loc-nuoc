...
<%
    List<Product> productsNotSolds = (List<Product>) request.getAttribute("productsNotSolds");
    if (productsNotSolds == null) productsNotSolds = new ArrayList<>();
%>
...
<head>
    <meta charset="UTF-8">
    <title>Sản phẩm không bán được</title>
    ...
    <div class="home-content">
        <div class="manager-product">
            <div class="" style="margin-bottom: 20px">
                <form action="./sanPhamNotSoldStartEnd" method="post">
            ...
            <div class="title">
                ...
                Sản phẩm không bán được từ <%= startDateConverted %> đến <%= endDateConverted %>
                <% } else { %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="table-id" class="table table-hover table-bordered">
                        ...
                        <tbody>
                        <%
                            for (Product product : productsNotSolds) {
